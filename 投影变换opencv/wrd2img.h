...
public:
	...
	*/
	void world2perspective_hugin(float x_src, float y_src, float z_src, float fov_dst, int h_dst, int w_dst, float D[4], float xy_dst[2]);
	...
	*/
	void world2fisheye_hugin(float x_src, float y_src, float z_src, float D_dst[4], float fov_dst, int h_dst, int w_dst, float xy_dst[2]);
